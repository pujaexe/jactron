...
// Plasmic Project: iQLrfYQ86tKsFeD4X4u2uv
// Component: KlhgK-3_Tudg
...
import sty from "./PlasmicButton.module.css"; // plasmic-import: KlhgK-3_Tudg/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ixtg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__akMyq)}
                role={"img"}
              />
            ),
